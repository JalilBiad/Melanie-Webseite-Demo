...
export function Offers() {
  ...
  return (
    <section id="angebote" className="py-24 lg:py-32 bg-stone-950">
            ...
            return (
              <div
                ...
                className={`reveal reveal-delay-${i % 3 + 1} ${
                  visible ? 'is-visible' : ''
                } group bg-stone-900/50 border border-stone-800 hover:border-clay-700/60 rounded-2xl p-7 transition-all duration-300 hover:-translate-y-1 cursor-pointer`}
                onClick={() => setSelected(offer)}
              >
                <div className="flex items-center justify-between mb-5">
                  <div className="w-12 h-12 rounded-xl bg-clay-900/40 flex items-center justify-center group-hover:bg-clay-800/60 transition-colors duration-300">
                ...
                <p className="text-clay-400 text-xs uppercase tracking-wider mb-2">
                  {offer.subtitle}
                </p>
                ...
                <div className="flex items-center gap-2 text-clay-400 text-sm group-hover:text-clay-300 transition-colors">
                  Mehr erfahren
                  <ArrowRight
                    size={14}
      ...
      {selected && (
        ...
        >
          <div
            className="bg-stone-900 border border-clay-900/50 rounded-2xl max-w-2xl w-full p-8 max-h-[85vh] overflow-y-auto"
